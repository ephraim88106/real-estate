...
const articles = [
  ...
  },
  {
    ...
    date: '2026-04-12',
    body: [
      '분당, 일산, 평촌, 산본, 중동으로 구성된 1기 신도시는 1989~1996년에 걸쳐 조성된 대한민국 최초의 대규모 계획 신도시다. 30년이 넘은 지금, 이 도시들은 한 세대의 노후화와 함께 물리적 한계에 직면해 있다.',
      ...
      '같은 1기 신도시지만 분당과 일산의 현실은 크게 다르다. 이 차이가 재정비 이후의 가치 변화에도 결정적인 영향을 미칠 것으로 보인다. 분당은 판교 테크노밸리 배후 주거지로서의 수요가 강력하다. 반면 일산은 서울 도심 출퇴근 접근성이 상대적으로 제한적이다.',
      ...
      '투자 관점에서 1기 신도시 선도지구 아파트는 \'이미 프리미엄이 상당 부분 반영된 상품\'이다. 선도지구 발표 이후 호가가 30~40% 이상 뛴 단지도 있다. 재건축이 완료되는 시점까지 추가 수익을 낼 수 있느냐는, 지금 들어가는 가격이 합리적인지에 달려 있다.'
    ]
  },
  {
    id: 1,
