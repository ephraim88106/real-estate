...
```
O  https://real-estate-7os.pages.dev/article-name
X  https://real-estate-7os.pages.dev/article-name.html
```
...
- Google Search Console — 사이트맵 제출: `https://real-estate-7os.pages.dev/sitemap.xml`
